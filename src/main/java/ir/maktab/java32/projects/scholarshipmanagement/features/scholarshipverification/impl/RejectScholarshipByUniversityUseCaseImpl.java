...
import ir.maktab.java32.projects.scholarshipmanagement.features.scholarshipverification.usecases.RejectScholarshipByUniversityUseCase;
...
@Service
public class RejectScholarshipByUniversityUseCaseImpl implements RejectScholarshipByUniversityUseCase {
    @Override
    public void rejected(int scholarshipId) {
        ...
        if (user != null && user.getRole().equals("Manager")) {
            ...
            try {
                ...
                // sql
                String sql = "update scholarship set status = 'RejectedByUniversity' " +
                        "where id = ?";
                // execute
